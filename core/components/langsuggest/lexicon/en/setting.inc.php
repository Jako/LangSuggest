...
$_lang['setting_langsuggest.debug_desc'] = 'Log debug information in the MODX error log.';
$_lang['setting_langsuggest.display_count'] = 'Display Count';
$_lang['setting_langsuggest.display_count_desc'] = 'Maximum display count of LangSuggest modal for each session, if a PHP session exist.';
$_lang['setting_langsuggest.no_session'] = 'Sesssion-less Contexts';
$_lang['setting_langsuggest.no_session_desc'] = 'Show LangSuggest on session-less contexts.';
$_lang['setting_langsuggest.tpl'] = 'Modal Template';
$_lang['setting_langsuggest.tpl_desc'] = 'The template chunk containing the LangSuggest modal.';
